...
<ul class="nav nav-pills nav-stacked" role="tablist">
  ...
  <li role="presentation"class="active"><a href="../glygl/JSGL.html">角色管理</a></li>
...
<ol class="breadcrumb">
  <li><a href="../index.html">趣分期后台管理</a></li>
  <li class="active">角色管理</li>
</ol>
<h3 align="center"><b>角色表</b></h3>
...
<div id="" class="">
  ...
  <div class="operationbutton">
  <a href="JSGL.html"  onclick="jump()" ><img src="../../image/delect.png">删除</a> 
  </div>
