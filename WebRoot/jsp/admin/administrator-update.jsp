        ...
        <div id="" class="adregistration-form">
          ...
          <form id="message" >
            <table class="sj">
              <td>管理员ID</td>
              <td>
                <input type="text" name="administrator-number" value="10010"readonly/>
              </td>
              <tr>
                <td>姓名</td>
                <td>
                  <input type="text" name="name"value="陈本杰" placeholder="必填"/>
                </td>
              </tr>
              <tr>
                <td>密码</td>
                <td>
                  <input type="text" name="password"value="12239892" placeholder="必填"/>
