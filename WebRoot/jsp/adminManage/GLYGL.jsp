...
<body>
	...
	<div id="" class="">
		...
		<div id="main" class="inline_div">
			...
			<input class='query-window' type="text" /><a class='query-picture'
				href="administrator-query.html"> <img
				src="../../image/query.png">查询</a>
			...
			<center>
				<div id="" class="">
					<div class="operationbutton">
						<a href="administrator-add.html"> <img
							src="../../image/add.png">添加</a>
					</div>
					<div class="operationbutton">
						<a href="GLYGL.html" onclick="jump()"> <img
