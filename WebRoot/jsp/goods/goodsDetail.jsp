	...
	<section class="main">
		...
		<section class="container">
			<div id="goodinfomain">
				...
				<div id="zoom">
					<div id="zoomMiddle"><img src="img/1m.jpg" alt=""><div id="make"></div></div>
					...
					<div id="zoomSmall">
						...
						<div id="zoomSmallImg">
							<ul>
								<li class="curr" ><img src="img/1m.jpg" alt=""></li>
								<li><img src="img/2m.jpg" alt=""></li>
								<li><img src="img/3m.jpg" alt=""></li>
								<li><img src="img/4m.jpg" alt=""></li>
								<li><img src="img/5m.jpg" alt=""></li>
								<li><img src="img/6m.jpg" alt=""></li>
							</ul>
						</div>
						<span class='right'>&gt;</span>
					</div>
					<div id="zoomLa"><img src="img/1m.jpg" alt=""></div>
				</div>
				<div class="goodinfo">
					<h1>iphone6土豪金</h1>
					...
					<table class="goodmoreinfo">
						...
						<tr class="imgShow">
							<th>颜色分类</th>
							<td><img src="img/1m.jpg" alt="" class="goodimg active"/>
								<img src="img/2m.jpg" alt="" class="goodimg"/></td>
						</tr>
						<tr>
							<th>分期选择</th>
							<td><span class="select">6*230</span> <span class="select">12*100</span></td>
						</tr>
						<tr>
							<th>购买数量</th>
