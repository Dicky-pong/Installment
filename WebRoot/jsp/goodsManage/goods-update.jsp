          ...
          <form id="message">
            <table>
              ...
              <tr>
                ...
                <td>期数</td>
                <td>
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>
                  3
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>
                  6
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>12
                </td>
                <td>
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>18
                </td>
                <td>
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>
                  24
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>36
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colspan="5">
                  ...
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>
                  粉红色
                  <input type="checkbox" id="inlineCheckbox1" value="option1" style='width:15px'>金色</td>
              </tr>

            </table>
            商品介绍信息
            <br />
            <textarea name="detail" cols="70" rows="5" ></textarea>
            <br />
