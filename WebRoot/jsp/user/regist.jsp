...
<div id="divMain">
  ...
  <div id="divBody">
<form action="<c:url value='/UserInfo_regist.do'/>" method="post" id="registForm">
    ...
    <table id="tableForm">
      ...
      <tr>
        <td></td>
        <td>
          <div id="divVerifyCode"><img id="imgVerifyCode" src="<c:url value='/VerifyCode_verify.do'/>"/></div>
        </td>
        <td>
